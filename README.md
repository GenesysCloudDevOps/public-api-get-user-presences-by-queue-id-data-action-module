A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get User Presences by Queue ID
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-user-presences-by-queue-id-data-action-module.git?ref=v1.0.0"
    action_name        = "Get User Presences by Queue ID"
